...
public abstract class ListTest<T> {
	...
	@Test
	public void testHasNextAndPrev() {//1,2,3
		assertEquals(dList.hasPrev(),false);
		assertEquals(dList.hasNext(),false);
		dList.insert(newInstance1);
		dList.insert(newInstance1);
		dList.insert(newInstance3);
		assertEquals(dList.hasPrev(),true);
		assertEquals(dList.hasNext(),false);
		dList.getPrev();
		assertEquals(dList.hasPrev(),true);
		assertEquals(dList.hasNext(),true);
		dList.getPrev();
		assertEquals(dList.hasPrev(),false);
