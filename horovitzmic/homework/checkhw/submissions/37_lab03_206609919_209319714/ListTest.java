...
public abstract class ListTest<T> {
	...
	public void testHasNextAndPrev() {
		//inserting the instances to the list
		dList.insert(newInstance1);
		dList.insert(newInstance2);
		dList.insert(newInstance3);
		dList.insert(newInstance1);
		dList.insert(newInstance2);
		//return true if the previous equals to the newinstance1
		assertEquals(dList.hasPrev(), true); //return true
		//return true if the next equals to the newinstance1
		assertEquals(dList.hasNext(), true); //return true
