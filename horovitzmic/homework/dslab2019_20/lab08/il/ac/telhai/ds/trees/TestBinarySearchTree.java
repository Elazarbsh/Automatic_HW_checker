...
public class TestBinarySearchTree {
	...
	private void TestAllTreeVals(BinaryTreeI<String> binaryTree, BinarySearchTree<PersonKey, Person> searchTree) {
		...
		BinarySearchTree<PersonKey,Person> leftSearch=null;
		if(left!=null)
			leftSearch = (BinarySearchTree<PersonKey,Person>) left;
		
		BinaryTreeI<Person> right=searchTree.getRight();
		BinarySearchTree<PersonKey,Person> rightSearch=null;
		if(right!=null)
			rightSearch = (BinarySearchTree<PersonKey,Person>)right;
