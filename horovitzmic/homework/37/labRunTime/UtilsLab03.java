...
public class UtilsLab03 {
	...
	private static final String PROPERTY_TIMER_CLASS_NAME_TO_TEST = "timerClassName";
	...
	public static class TimerFactory {
		public static Timer getTimer() {
			Timer timer = null;
			String timerClassName = System.getProperty(PROPERTY_TIMER_CLASS_NAME_TO_TEST);
			try {
				timer = (Timer) Class.forName(timerClassName).newInstance();
			} catch (Exception e) {
				e.printStackTrace();
			}
			return timer;
